...
export default function Landing() {
  ...
  tl.from(".thumb", {duration: 1, y: 30, opacity: 0});
  ...
  return (
    <div class="hero">
        <div class="content">
            ...
            <p class="thumb">👇 Meet Jason Tseng</p>
            <svg class="scroll" width="40" height="77" viewBox="0 0 40 77">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" class="hero-design" width="686" height="688" viewBox="0 0 686 688">
                  <g id="blockdesign" transform="translate(-935 -289)">
                    <rect class="square-anim1" data-name="Rectangle 2" width="172" height="172" rx="19" transform="translate(1277 289)" fill="#00f7ff"/>
                    ...
                    <rect class="square-anim4" data-name="Rectangle 5" width="172" height="172" rx="19" transform="translate(1277 633)" fill="#e5d5fa"/>
